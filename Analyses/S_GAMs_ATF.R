...
sGAM.ATFpa.full = gam(PA ~ te(lon, lat, bs='tp', m=1) + s(bathy, bs='tp', k=6, m=1) + s(slope, bs='tp', k=4, m=1) + s(BPI, bs='tp', k=4, m=1) + s(phi, bs='tp', k=4, m=1) + s(ROMS_BT, bs='tp', k=4, m=1) + sponges + corals + whips + offset(log(AreaSwept)), data = ATF, family = binomial(link="cloglog"), method = "GCV.Cp") 
  ...
  save(sGAM.ATFpa.full, file = "Analyses/sGAM_ATFpa_full.rda")
# load("Analyses/sGAM_ATFpa_full.rda")
...
# adj-R2 = 0.612; Deviance = 55.3%; UBRE = -0.39584
  save(sGAM.ATFpa.ind.cov, file = "Analyses/sGAM_ATFpa_ind_cov.rda")
# load("Analyses/sGAM_ATFpa_ind_cov.rda")
...
# adj-R2 = 0.612; Deviance = 55.3%; UBRE = -0.3959
  save(sGAM.ATFpa.alt.1, file = "Analyses/sGAM_ATFpa_alt1.rda")
# load("Analyses/sGAM_ATFpa_alt1.rda")
  
# Save best-fit model based on GCV/GCV/UBRE: 
sGAM.ATFpa.best = sGAM.ATFpa.ind.cov
  summary(sGAM.ATFpa.best)
  save(sGAM.ATFpa.best, file = "Analyses/sGAM_ATFpa_best.rda")
# load("Analyses/sGAM_ATFpa_best.rda")
...
sGAM.ATF.N.full = gam(adjN ~ te(lon, lat, bs='tp', m=1) + s(bathy, bs='tp', k=6, m=1) + s(slope, bs='tp', k=4, m=1) + s(BPI, bs='tp', k=4, m=1) + s(phi, bs='tp', k=4, m=1) + s(ROMS_BT, bs='tp', k=4, m=1) + sponges + corals + whips + offset(log(AreaSwept)), data = ATF_catch, family = poisson(link="log"), method = "GCV.Cp")  
  ...
  save(sGAM.ATF.N.full, file = "Analyses/sGAM_ATF_N_full.rda")
# load("Analyses/sGAM_ATF_N_full.rda")
...
# adj-R2 = 0.154; Deviance = 34.0%; UBRE = 22.058
  save(sGAM.ATF.N.ind.cov, file = "Analyses/sGAM_ATF_N_ind_cov.rda")
# load("Analyses/sGAM_ATF_N_ind_cov.rda")
  
# Save best-fit (full) model:
sGAM.ATF.N.best = sGAM.ATF.N.ind.cov 
  summary(sGAM.ATF.N.best); sum(sGAM.ATF.N.best$edf)
# adj-R2 = 0.154; Deviance = 34.0%; UBRE = 22.058
  save(sGAM.ATF.N.best, file = "Analyses/sGAM_ATF_N_best.rda")
# load("Analyses/sGAM_ATF_N_best.rda")
...
sGAM.ATF.WT.full = gam(adjWT ~ te(lon, lat, bs='tp', m=1) + s(bathy, bs='tp', k=6, m=1) + s(slope, bs='tp', k=4, m=1) + s(BPI, bs='tp', k=4, m=1) + s(phi, bs='tp', k=4, m=1) + s(ROMS_BT, bs='tp', k=4, m=1) + sponges + corals + whips + offset(log(AreaSwept)), data = ATF_catch, family = Gamma(link="log"), method = "GCV.Cp")  
  ...
  save(sGAM.ATF.WT.full, file = "Analyses/sGAM_ATF_WT_full.rda")
# load("Analyses/sGAM_ATF_WT_full.rda")
...
# adj-R2 = 0.148; Deviance = 37.8%; GCV = 0.93465
  save(sGAM.ATF.WT.ind.cov, file = "Analyses/sGAM_ATF_WT_ind_cov.rda")
# load("Analyses/sGAM_ATF_WT_ind_cov.rda")
...
# adj-R2 = 0.148; Deviance = 37.8%; GCV = 0.93435
  save(sGAM.ATF.WT.alt_1, file = "Analyses/sGAM_ATF_WT_alt_1.rda")
# load("Analyses/sGAM_ATF_WT_alt_1.rda")
...
# adj-R2 = 0.148; Deviance = 37.8%; GCV = 0.93415
  save(sGAM.ATF.WT.alt_2, file = "Analyses/sGAM_ATF_WT_alt_2.rda")
# load("Analyses/sGAM_ATF_WT_alt_2.rda")
  
# Save best-fit model:
sGAM.ATF.WT.best = sGAM.ATF.WT.alt_2  
  # same GCV, higher R2, more parsimonious
  summary(sGAM.ATF.WT.best)
  save(sGAM.ATF.WT.best, file = "Analyses/sGAM_ATF_WT_best.rda")
# load("Analyses/sGAM_ATF_WT_best.rda")
...
ATFpa.predict = ATFpa.predict %>%
  ...
  save(ATFpa.predict, file = "Analyses/sATF_pa_predict.rda")
# load("Analyses/sATF_pa_predict.rda")
...
ATF.N.predict = ATF.N.predict %>%
  ...
  save(ATF.N.predict, file = "Analyses/sATF_N_predict.rda")
# load("Analyses/sATF_N_predict.rda")
...
ATF.WT.predict = ATF.WT.predict %>%
  ...
  save(ATF.WT.predict, file = "Analyses/sATF_WT_predict.rda")
# load("Analyses/sATF_WT_predict.rda")
...
ATF.predict$ATF_Bio = (with(ATF.predict, pa.fit * WT.fit) / ATF.predict$AreaSwept)
  save(ATF.predict, file = "Analyses/sATF_predict.rda")
# load("Analyses/sATF_predict.rda")
...
sATF_full = st_join(ATF_sf, ATF.predict_sf, join = st_nearest_feature, left = T)
  save(sATF_full, file = "Analyses/sATF_pred.rda")
# load("Analyses/sATF_pred.rda")
...
pa.predictions_all = rbind(pa.predictions_all, pa.obs.pred)}
  save(pa.predictions_all, file = "Analyses/sATF_pa_retro.rda") 
# load("Analyses/sATF_pa_retro.rda")
...
N.predictions_all = rbind(N.predictions_all, N.obs.pred)}
  save(N.predictions_all, file = "Analyses/sATF_N_retro.rda") 
# load("Analyses/sATF_N_retro.rda")
...
WT.predictions_all = rbind(WT.predictions_all, WT.obs.pred)}
  save(WT.predictions_all, file = "Analyses/sATF_WT_retro.rda") 
# load("Analyses/sATF_WT_retro.rda")
