...
d2GAM.ATFpa.full = gam(PA ~ s(Year, bs="cr", m=1) + te(lon, lat, bs='tp', m=1) + s(bathy, bs='tp', k=6, m=1) + s(slope, bs='tp', k=4, m=1) + s(BPI, bs='tp', k=4, m=1) + s(phi, bs='tp', k=4, m=1) + s(ROMS_BT, bs='tp', k=4, m=1) + s(lon, lat, by=CPE, bs='tp', m=1) + sponges + corals + whips + offset(log(AreaSwept)), data = ATF, family = binomial(link="cloglog"), method = "GCV.Cp")
  ...
  save(d2GAM.ATFpa.full, file = "Analyses/d2GAM_ATFpa_full.rda")
# load("Analyses/d2GAM_ATFpa_full.rda")
...
# R-sq = 0.721; Dev. = 67.3%; UBRE = -0.55095
  save(d2GAM.ATFpa.ind.cov.full, file = "Analyses/d2GAM_ATFpa_ind_cov.rda")
# load("Analyses/d2GAM_ATFpa_ind_cov.rda")
...
# R-sq = 0.721; Dev. = 67.3%; UBRE = -0.55096
  save(d2GAM.ATFpa.alt.1, file = "Analyses/d2GAM_ATFpa_alt1.rda")
# load("Analyses/d2GAM_ATFpa_alt1.rda")
...
# R-sq = 0.721; Dev. = 67.2%; UBRE = -0.5509
  save(d2GAM.ATFpa.alt.2, file = "Analyses/d2GAM_ATFpa_alt2.rda")
# load("Analyses/d2GAM_ATFpa_alt2.rda")
...
# R-sq = 0.721; Dev. = 67.2%; UBRE = -0.551
  save(d2GAM.ATFpa.alt.3, file = "Analyses/d2GAM_ATFpa_alt3.rda")
# load("Analyses/d2GAM_ATFpa_alt3.rda")
  
# Save best-fit model based on GCV/UBRE:  
d2GAM.ATFpa.best = d2GAM.ATFpa.alt.3
  summary(d2GAM.ATFpa.best)
  save(d2GAM.ATFpa.best, file = "Analyses/d2GAM_ATFpa_best.rda")
# load("Analyses/d2GAM_ATFpa_best.rda")
...
d2GAM.ATF.N.full = gam(adjN ~ s(Year, bs="cr", m=1) + te(lon, lat, bs='tp', m=1) + s(bathy, bs='tp', k=6, m=1) + s(slope, bs='tp', k=4, m=1) + s(BPI, bs='tp', k=4, m=1) + s(phi, bs='tp', k=4, m=1) + s(ROMS_BT, bs='tp', k=4, m=1) + s(lon, lat, by=CPE, bs='tp', m=1) + sponges + corals + whips + offset(log(AreaSwept)), data = ATF_catch, family = poisson(link="log"), method = "GCV.Cp")  
  ...
  save(d2GAM.ATF.N.full, file = "Analyses/d2GAM_ATF_N_full.rda")
# load("Analyses/d2GAM_ATF_N_full.rda")
...
# adj-R2 = 0.193; Deviance = 41.3%; UBRE = 19.523
  save(d2GAM.ATF.N.ind.cov, file = "Analyses/d2GAM_ATF_N_ind_cov.rda")
# load("Analyses/d2GAM_ATF_N_ind_cov.rda")
  
# Save best-fit model: 
d2GAM.ATF.N.best = d2GAM.ATF.N.ind.cov
  summary(d2GAM.ATF.N.best); sum(d2GAM.ATF.N.best$edf)
  save(d2GAM.ATF.N.best, file = "Analyses/d2GAM_ATF_N_best.rda")
# load("Analyses/d2GAM_ATF_N_best.rda")
...
d2GAM.ATF.WT.full = gam(adjWT ~ s(Year, bs="cr", m=1) + te(lon, lat, bs='tp', m=1) + s(bathy, bs='tp', k=6, m=1) + s(slope, bs='tp', k=4, m=1) + s(BPI, bs='tp', k=4, m=1) + s(phi, bs='tp', k=4, m=1) + s(ROMS_BT, bs='tp', k=4, m=1) + s(lon, lat, by=CPE, bs='tp', m=1) + sponges + corals + whips + offset(log(AreaSwept)), data = ATF_catch, family = Gamma(link="log"), method = "GCV.Cp")  
  ...
  save(d2GAM.ATF.WT.full, file = "Analyses/d2GAM_ATF_WT_full.rda")
# load("Analyses/d2GAM_ATF_WT_full.rda")
...
# adj-R2 = 0.160; Deviance = 47.0%; GCV = 0.80703
  save(d2GAM.ATF.WT.ind.cov, file = "Analyses/d2GAM_ATF_WT_ind_cov.rda")
# load("Analyses/d2GAM_ATF_WT_ind_cov.rda")
...
# adj-R2 = 0.161; Deviance = 46.9%; GCV = 0.80721
  save(d2GAM.ATF.WT.alt.1, file = "Analyses/d2GAM_ATF_WT_alt1.rda")
# load("Analyses/d2GAM_ATF_WT_alt1.rda")
  
# Save best-fit model: 
d2GAM.ATF.WT.best = d2GAM.ATF.WT.ind.cov
  summary(d2GAM.ATF.WT.best)
  save(d2GAM.ATF.WT.best, file = "Analyses/d2GAM_ATF_WT_best.rda")
# load("Analyses/d2GAM_ATF_WT_best.rda")
...
ATFpa.predict = ATFpa.predict %>%
  ...
  save(ATFpa.predict, file = "Analyses/d2ATF_pa_predict.rda")
# load("Analyses/d2ATF_pa_predict.rda")
...
ATF.N.predict = ATF.N.predict %>%
  ...
  save(ATF.N.predict, file = "Analyses/d2ATF_N_predict.rda")
# load("Analyses/d2ATF_N_predict.rda")
...
ATF.WT.predict = ATF.WT.predict %>%
  ...
  save(ATF.WT.predict, file = "Analyses/d2ATF_WT_predict.rda")
# load("Analyses/d2ATF_WT_predict.rda")
...
ATF.predict$ATF_Bio = with(ATF.predict, pa.fit * WT.fit)
  save(ATF.predict, file = "Analyses/d2ATF_predict.rda")
# load("Analyses/d2ATF_predict.rda")  
...
d2ATF_full = d2ATF_full %>%
  rename(Year = Year.x)
  save(d2ATF_full, file = "Analyses/d2ATF_obs_pred.rda")
# load("Analyses/d2ATF_obs_pred.rda")
...
pa.predictions_all = pa.predictions_all %>%
  rename(pa.fit = fit, pa.se.fit = se.fit)
  save(pa.predictions_all, file = "Analyses/d2ATF_pa_retro.rda") 
# load("Analyses/d2ATF_pa_retro.rda")
...
N.predictions_all = N.predictions_all %>%
  rename(N.fit = fit, N.se.fit = se.fit)
  save(N.predictions_all, file = "Analyses/d2ATF_N_retro.rda") 
# load("Analyses/d2ATF_N_retro.rda")
...
WT.predictions_all = WT.predictions_all %>%
  rename(WT.fit = fit, WT.se.fit = se.fit)
  save(WT.predictions_all, file = "Analyses/d2ATF_WT_retro.rda") 
# load("Analyses/d2ATF_WT_retro.rda")
...
d2ATF_retro_all = as.data.frame(d2ATF.obs.pred_all)
  save(d2ATF_retro_all, file = "Analyses/d2ATF_obs_pred_retro.rda")
# load("Analyses/d2ATF_obs_pred_retro.rda")
