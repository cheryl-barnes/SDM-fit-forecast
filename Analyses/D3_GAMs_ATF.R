...
d3GAM.ATFpa.full = gam(PA ~ s(Year, bs="cr", m=1) + te(lon, lat, bs='tp', m=1) + ti(lon, lat, Year, bs='tp', m=1) + s(bathy, bs='tp', k=6, m=1) + s(slope, bs='tp', k=4, m=1) + s(BPI, bs='tp', k=4, m=1) + s(phi, bs='tp', k=4, m=1) + s(ROMS_BT, bs='tp', k=4, m=1) + s(lon, lat, by=CPE, bs='tp', m=1) + sponges + corals + whips + offset(log(AreaSwept)), data = ATF, family = binomial(link="cloglog"), method = "GCV.Cp")
  ...
  save(d3GAM.ATFpa.full, file = "Analyses/d3GAM_ATFpa_full.rda")
# load("Analyses/d3GAM_ATFpa_full.rda")
...
# R-sq = 0.737; Dev. = 69.5%; UBRE = -0.57304
  save(d3GAM.ATFpa.ind.cov.full, file = "Analyses/d3GAM_ATFpa_ind_cov.rda")
# load("Analyses/d3GAM_ATFpa_ind_cov.rda")
...
# R-sq = 0.736; Dev. = 69.5%; UBRE = -0.57313
  save(d3GAM.ATFpa.alt.1, file = "Analyses/d3GAM_ATFpa_alt1.rda")
# load("Analyses/d3GAM_ATFpa_alt1.rda")
...
# R-sq = 0.736; Dev. = 69.5%; UBRE = -0.57319
  save(d3GAM.ATFpa.alt.2, file = "Analyses/d3GAM_ATFpa_alt2.rda")
# load("Analyses/d3GAM_ATFpa_alt2.rda")
...
# R-sq = 0.736; Dev. = 69.4%; UBRE = -0.57312
  save(d3GAM.ATFpa.alt.3, file = "Analyses/d3GAM_ATFpa_alt3.rda")
# load("Analyses/d3GAM_ATFpa_alt3.rda")

# Save best-fit model based on GCV/UBRE:  
d3GAM.ATFpa.best = d3GAM.ATFpa.alt.2 
  summary(d3GAM.ATFpa.best)
  save(d3GAM.ATFpa.best, file = "Analyses/FigS4_d3GAM_ATF_PA.rda")
# load("Analyses/FigS4_d3GAM_ATF_PA.rda")
...
d3GAM.ATF.N.full = gam(adjN ~ s(Year, bs="cr", m=1) + te(lon, lat, bs='tp', m=1) + ti(lon, lat, Year, bs='tp', m=1) + s(bathy, bs='tp', k=6, m=1) + s(slope, bs='tp', k=4, m=1) + s(BPI, bs='tp', k=4, m=1) + s(phi, bs='tp', k=4, m=1) + s(ROMS_BT, bs='tp', k=4, m=1) + s(lon, lat, by=CPE, bs='tp', m=1) + sponges + corals + whips + offset(log(AreaSwept)), data = ATF_catch, family = poisson(link="log"), method = "GCV.Cp")  
  ...
  save(d3GAM.ATF.N.full, file = "Analyses/d3GAM_ATF_N.rda")
# load("Analyses/d3GAM_ATF_N.rda")
...
# adj-R2 = 0.224; Deviance = 46.5%; UBRE = 17.737
  save(d3GAM.ATF.N.ind.cov, file = "Analyses/d3GAM_ATF_N_ind_cov.rda")
# load("Analyses/d3GAM_ATF_N_ind_cov.rda")
  
# Save best-fit model: 
d3GAM.ATF.N.best = d3GAM.ATF.N.ind.cov
  summary(d3GAM.ATF.N.best)
  save(d3GAM.ATF.N.best, file = "Analyses/d3GAM_ATF_N_best.rda")
# load("Analyses/d3GAM_ATF_N_best.rda")
...
d3GAM.ATF.WT.full = gam(adjWT ~ s(Year, bs="cr", m=1) + te(lon, lat, bs='tp', m=1) + ti(lon, lat, Year, bs='tp', m=1) + s(bathy, bs='tp', k=6, m=1) + s(slope, bs='tp', k=4, m=1) + s(BPI, bs='tp', k=4, m=1) + s(phi, bs='tp', k=4, m=1) + s(ROMS_BT, bs='tp', k=4, m=1) + s(lon, lat, by=CPE, bs='tp', m=1) + sponges + corals + whips + offset(log(AreaSwept)), data = ATF_catch, family = Gamma(link="log"), method = "GCV.Cp")  
  ...
  save(d3GAM.ATF.WT.full, file = "Analyses/d3GAM_ATF_WT_full.rda")
# load("Analyses/d3GAM_ATF_WT_full.rda")
...
# adj-R2 = 0.185; Deviance = 51.5%; GCV = 0.75375
  save(d3GAM.ATF.WT.ind.cov, file = "Analyses/d3GAM_ATF_WT_ind_cov.rda")
# load("Analyses/d3GAM_ATF_WT_ind_cov.rda")
...
# adj-R2 = 0.185; Deviance = 51.5%; GCV = 0.75352
  save(d3GAM.ATF.WT.alt.1, file = "Analyses/d3GAM_ATF_WT_ind.cov.rda")
# load("Analyses/d3GAM_ATF_WT_ind_cov.rda")
  
# Save best-fit model: 
d3GAM.ATF.WT.best = d3GAM.ATF.WT.alt.1
  summary(d3GAM.ATF.WT.best)
  save(d3GAM.ATF.WT.best, file = "Analyses/d3GAM_ATF_WT_best.rda")
# load("Analyses/d3GAM_ATF_WT_best.rda")
...
ATFpa.predict = ATFpa.predict %>%
  ...
  save(ATFpa.predict, file = "Analyses/d3ATF_pa_predict.rda")
# load("Analyses/d3ATF_pa_predict.rda")
...
ATF.N.predict = ATF.N.predict %>%
  ...
  save(ATF.N.predict, file = "Analyses/d3ATF_N_predict.rda")
# load("Analyses/d3ATF_N_predict.rda")
...
ATF.WT.predict = ATF.WT.predict %>%
  ...
  save(ATF.WT.predict, file = "Analyses/d3ATF_WT_predict.rda")
# load("Analyses/d3ATF_WT_predict.rda")
...
ATF.predict$ATF_Bio = with(ATF.predict, pa.fit * WT.fit)
  save(ATF.predict, file = "Analyses/d3ATF_predict.rda")
# load("Analyses/d3ATF_predict.rda")  
...
d3ATF_full = d3ATF_full %>%
  rename(Year = Year.x)
  save(d3ATF_full, file = "Analyses/d3ATF_obs_pred.rda")
# load("Analyses/d3ATF_obs_pred.rda")
...
ATF.EFH.pa.predict.yr$pa.EFH.perc.yr = ordered(ATF.EFH.pa.predict.yr$pa.EFH.perc.yr, levels=c("95","75","50","25"))
  ...
  save(ATF.EFH.pa.predict.yr, file = "Analyses/d3ATF_EFH_pa_contour.rda")
# load("Analyses/d3ATF_EFH_pa_contour.rda")
...
ATF.EFH.Abun.predict.yr$Abun.EFH.perc.yr = ordered(ATF.EFH.Abun.predict.yr$Abun.EFH.perc.yr, levels=c("95","75","50","25"))
  ...
  save(ATF.EFH.Abun.predict.yr, file = "Analyses/d3ATF_EFH_Abun_contour.rda")
# load("Analyses/d3ATF_EFH_Abun_contour.rda")
...
ATF.EFH.Bio.predict.yr$Bio.EFH.perc.yr = ordered(ATF.EFH.Bio.predict.yr$Bio.EFH.perc.yr, levels=c("95","75","50","25"))
  ...
  save(ATF.EFH.Bio.predict.yr, file = "Analyses/d3ATF_EFH_Bio_contour.rda")
# load("Analyses/d3ATF_EFH_Bio_contour.rda")
...
pa.predictions_all = pa.predictions_all %>%
  rename(pa.fit = fit, pa.se.fit = se.fit)
  save(pa.predictions_all, file = "Analyses/d3ATF_pa_retro.rda") 
# load("Analyses/d3ATF_pa_retro.rda")
...
N.predictions_all = N.predictions_all %>%
  rename(N.fit = fit, N.se.fit = se.fit)
  save(N.predictions_all, file = "Analyses/d3ATF_N_retro.rda") 
# load("Analyses/d3ATF_N_retro.rda")
...
WT.predictions_all = WT.predictions_all %>%
  rename(WT.fit = fit, WT.se.fit = se.fit)
  save(WT.predictions_all, file = "Analyses/d3ATF_WT_retro.rda") 
# load("Analyses/d3ATF_WT_retro.rda")
