...
sGAM.WEPpa.full = gam(PA ~ te(lon, lat, bs='tp', m=1) + s(bathy, bs='tp', k=6, m=1) + s(slope, bs='tp', k=4, m=1) + s(BPI, bs='tp', k=4, m=1) + s(phi, bs='tp', k=4, m=1) + s(ROMS_BT, bs='tp', k=4, m=1) + sponges + corals + whips + offset(log(AreaSwept)), data = WEP, family = binomial(link="cloglog"), method = "GCV.Cp") 
  ...
  save(sGAM.WEPpa.full, file = "Analyses/sGAM_WEPpa_full.rda")
# load("Analyses/sGAM_WEPpa_full.rda")
...
# adj-R2 = 0.342; Deviance = 32.6%; UBRE = -0.45605
  save(sGAM.WEPpa.ind.cov, file = "Analyses/sGAM_WEPpa_ind_cov.rda")
# load("Analyses/sGAM_WEPpa_ind_cov.rda")
...
# adj-R2 = 0.342; Deviance = 32.6%; UBRE = -0.45611
  save(sGAM.WEPpa.alt.1, file = "Analyses/sGAM_WEPpa_alt1.rda")
# load("Analyses/sGAM_WEPpa_alt1.rda")
  
# Save best-fit model based on GCV/GCV/UBRE: 
sGAM.WEPpa.best = sGAM.WEPpa.alt.1
  summary(sGAM.WEPpa.best)
  save(sGAM.WEPpa.best, file = "Analyses/sGAM_WEPpa_best.rda")
# load("Analyses/sGAM_WEPpa_best.rda")
...
sGAM.WEP.N.full = gam(adjN ~ te(lon, lat, bs='tp', m=1) + s(bathy, bs='tp', k=6, m=1) + s(slope, bs='tp', k=4, m=1) + s(BPI, bs='tp', k=4, m=1) + s(phi, bs='tp', k=4, m=1) + s(ROMS_BT, bs='tp', k=4, m=1) + sponges + corals + whips + offset(log(AreaSwept)), data = WEP_catch, family = poisson(link="log"), method = "GCV.Cp")  
  ...
  save(sGAM.WEP.N.full, file = "Analyses/sGAM_WEP_N_full.rda")
# load("Analyses/sGAM_WEP_N_full.rda")
...
# adj-R2 = 0.0946; Deviance = 24.7%; UBRE = 944.2
  save(sGAM.WEP.N.ind.cov, file = "Analyses/sGAM_WEP_N_ind_cov.rda")
# load("Analyses/sGAM_WEP_N_ind_cov.rda")

# Save best-fit (full) model:
sGAM.WEP.N.best = sGAM.WEP.N.ind.cov 
  summary(sGAM.WEP.N.best); sum(sGAM.WEP.N.best$edf)
  save(sGAM.WEP.N.best, file = "Analyses/sGAM_WEP_N_best.rda")
# load("Analyses/sGAM_WEP_N_best.rda")
...
sGAM.WEP.WT.full = gam(adjWT ~ te(lon, lat, bs='tp', m=1) + s(bathy, bs='tp', k=6, m=1) + s(slope, bs='tp', k=4, m=1) + s(BPI, bs='tp', k=4, m=1) + s(phi, bs='tp', k=4, m=1) + s(ROMS_BT, bs='tp', k=4, m=1) + sponges + corals + whips + offset(log(AreaSwept)), data = WEP_catch, family = Gamma(link="log"), method = "GCV.Cp")  
  ...
  save(sGAM.WEP.WT.full, file = "Analyses/sGAM_WEP_WT_full.rda")
# load("Analyses/sGAM_WEP_WT_full.rda")
...
# adj-R2 = 0.077; Deviance = 24.4%; GCV = 2.1125
  save(sGAM.WEP.WT.ind.cov, file = "Analyses/sGAM_WEP_WT_ind_cov.rda")
# load("Analyses/sGAM_WEP_WT_ind_cov.rda")

# Save best-fit model:
sGAM.WEP.WT.best = sGAM.WEP.WT.ind.cov 
  summary(sGAM.WEP.WT.best)
  save(sGAM.WEP.WT.best, file = "Analyses/sGAM_WEP_WT_best.rda")
# load("Analyses/sGAM_WEP_WT_best.rda")
...
WEPpa.predict = WEPpa.predict %>%
  ...
  save(WEPpa.predict, file = "Analyses/sWEP_pa_predict.rda")
# load("Analyses/sWEP_pa_predict.rda")
...
WEP.N.predict = WEP.N.predict %>%
  ...
  save(WEP.N.predict, file = "Analyses/sWEP_N_predict.rda")
# load("Analyses/sWEP_N_predict.rda")
...
WEP.WT.predict = WEP.WT.predict %>%
  ...
  save(WEP.WT.predict, file = "Analyses/sWEP_WT_predict.rda")
# load("Analyses/sWEP_WT_predict.rda")
...
WEP.predict$WEP_Bio = (with(WEP.predict, pa.fit * WT.fit) / WEP.predict$AreaSwept)
  save(WEP.predict, file = "Analyses/sWEP_predict.rda")
# load("Analyses/sWEP_predict.rda")
...
sWEP_full = st_join(WEP_sf, WEP.predict_sf, join = st_nearest_feature, left = T)
  save(sWEP_full, file = "Analyses/sWEP_obs_pred.rda")
# load("Analyses/sWEP_obs_pred.rda")
...
pa.predictions_all = rbind(pa.predictions_all, pa.obs.pred)}
  save(pa.predictions_all, file = "Analyses/sWEP_pa_retro.rda") 
# load("Analyses/sWEP_pa_retro.rda")
...
N.predictions_all = rbind(N.predictions_all, N.obs.pred)}
  save(N.predictions_all, file = "Analyses/sWEP_N_retro.rda") 
# load("Analyses/sWEP_N_retro.rda")
...
WT.predictions_all = rbind(WT.predictions_all, WT.obs.pred)}
  save(WT.predictions_all, file = "Analyses/sWEP_WT_retro.rda") 
# load("Analyses/sWEP_WT_retro.rda")
