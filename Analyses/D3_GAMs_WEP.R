...
d3GAM.WEPpa.full = gam(PA ~ s(Year, bs="cr", m=1) + te(lon, lat, bs='tp', m=1) + ti(lon, lat, Year, bs='tp', m=1) + s(bathy, bs='tp', k=6, m=1) + s(slope, bs='tp', k=4, m=1) + s(BPI, bs='tp', k=4, m=1) + s(phi, bs='tp', k=4, m=1) + s(ROMS_BT, bs='tp', k=4, m=1) + s(lon, lat, by=CPE, bs='tp', m=1) + sponges + corals + whips + offset(log(AreaSwept)), data = WEP, family = binomial(link="cloglog"), method = "GCV.Cp")
  ...
  save(d3GAM.WEPpa.full, file = "Analyses/d3GAM_WEPpa_full.rda")
# load("Analyses/d3GAM_WEPpa_full.rda")
...
# R-sq = 0.496; Dev. = 48.5%; UBRE = -0.57047
  save(d3GAM.WEPpa.ind.cov.full, file = "Analyses/d3GAM_WEPpa_ind_cov.rda")
# load("Analyses/d3GAM_WEPpa_ind_cov.rda")
...
# R-sq = 0.496; Dev. = 48.5%; UBRE = -0.5706
  save(d3GAM.WEPpa.alt.1, file = "Analyses/d3GAM_WEPpa_alt1.rda")
# load("Analyses/d3GAM_WEPpa_alt1.rda")
...
# R-sq = 0.496; Dev. = 48.5%; UBRE = -0.5706
  save(d3GAM.WEPpa.alt.2, file = "Analyses/d3GAM_WEPpa_alt2.rda")
# load("Analyses/d3GAM_WEPpa_alt2.rda")
...
d3GAM.WEPpa.best = d3GAM.WEPpa.alt.2 
  ...
  save(d3GAM.WEPpa.best, file = "Analyses/d3GAM_WEPpa_best.rda")
# load("Analyses/d3GAM_WEPpa_best.rda")
...
d3GAM.WEP.N.full = gam(adjN ~ s(Year, bs="cr", m=1) + te(lon, lat, bs='tp', m=1) + ti(lon, lat, Year, bs='tp', m=1) + s(bathy, bs='tp', k=6, m=1) + s(slope, bs='tp', k=4, m=1) + s(BPI, bs='tp', k=4, m=1) + s(phi, bs='tp', k=4, m=1) + s(ROMS_BT, bs='tp', k=4, m=1) + s(lon, lat, by=CPE, bs='tp', m=1) + sponges + corals + whips + offset(log(AreaSwept)), data = WEP_catch, family = poisson(link="log"), method = "GCV.Cp")  
  ...
  save(d3GAM.WEP.N.full, file = "Analyses/d3GAM_WEP_N_full.rda")
# load("Analyses/d3GAM_WEP_N_full.rda")
...
# adj-R2 = 0.147; Deviance = 35.0%; UBRE = 814.93
  save(d3GAM.WEP.N.ind.cov, file = "Analyses/d3GAM_WEP_N_ind.rda")
# load("Analyses/d3GAM_WEP_N_ind_cov.rda")
  
# Save best-fit model: 
d3GAM.WEP.N.best = d3GAM.WEP.N.ind.cov
  summary(d3GAM.WEP.N.best)
  save(d3GAM.WEP.N.best, file = "Analyses/d3GAM_WEP_N_best.rda")
# load("Analyses/d3GAM_WEP_N_best.rda")
...
d3GAM.WEP.WT.full = gam(adjWT ~ s(Year, bs="cr", m=1) + te(lon, lat, bs='tp', m=1) + ti(lon, lat, Year, bs='tp', m=1) + s(bathy, bs='tp', k=6, m=1) + s(slope, bs='tp', k=4, m=1) + s(BPI, bs='tp', k=4, m=1) + s(phi, bs='tp', k=4, m=1) + s(ROMS_BT, bs='tp', k=4, m=1) + s(lon, lat, by=CPE, bs='tp', m=1) + sponges + corals + whips + offset(log(AreaSwept)), data = WEP_catch, family = Gamma(link="log"), method = "GCV.Cp")  
  ...
  save(d3GAM.WEP.WT.full, file = "Analyses/d3GAM_WEP_WT_full.rda")
# load("Analyses/d3GAM_WEP_WT_full.rda")
...
# adj-R2 = 0.0926; Deviance = 35.9%; GCV = 1.8164
  save(d3GAM.WEP.WT.ind.cov, file = "Analyses/d3GAM_WEP_WT_ind_cov.rda")
# load("Analyses/d3GAM_WEP_WT_ind_cov.rda")

# Save best-fit model: 
d3GAM.WEP.WT.best = d3GAM.WEP.WT.ind.cov
  summary(d3GAM.WEP.WT.best)
  save(d3GAM.WEP.WT.best, file = "Analyses/d3GAM_WEP_WT_best.rda")
# load("Analyses/d3GAM_WEP_WT_best.rda")
...
WEPpa.predict = WEPpa.predict %>%
  ...
  save(WEPpa.predict, file = "Analyses/d3WEP_pa_predict.rda")
# load("Analyses/d3WEP_pa_predict.rda")
...
WEP.N.predict = WEP.N.predict %>%
  ...
  save(WEP.N.predict, file = "Analyses/d3WEP_N_predict.rda")
# load("Analyses/d3WEP_N_predict.rda")
...
WEP.WT.predict = WEP.WT.predict %>%
  ...
  save(WEP.WT.predict, file = "Analyses/d3WEP_WT_predict.rda")
# load("Analyses/d3WEP_WT_predict.rda")
...
WEP.predict$WEP_Bio = with(WEP.predict, pa.fit * WT.fit)
  save(WEP.predict, file = "Analyses/d3WEP_predict.rda")
# load("Analyses/d3WEP_predict.rda")  
...
d3WEP_full = d3WEP_full %>%
  rename(Year = Year.x)
  save(d3WEP_full, file = "Analyses/d3WEP_obs_pred.rda")
# load("Analyses/d3WEP_obs_pred.rda")
...
WEP.EFH.pa.predict.yr$pa.EFH.perc.yr = ordered(WEP.EFH.pa.predict.yr$pa.EFH.perc.yr, levels=c("95","75","50","25"))
  ...
  save(WEP.EFH.pa.predict.yr, file = "Analyses/d3WEP_EFH_pa_contour.rda")
# load("Analyses/d3WEP_EFH_pa_contour.rda")
...
WEP.EFH.Abun.predict.yr$Abun.EFH.perc.yr = ordered(WEP.EFH.Abun.predict.yr$Abun.EFH.perc.yr, levels=c("95","75","50","25"))
  ...
  save(WEP.EFH.Abun.predict.yr, file = "Analyses/d3WEP_EFH_Abun_contour.rda")
# load("Analyses/d3WEP_EFH_Abun_contour.rda")
...
WEP.EFH.Bio.predict.yr$Bio.EFH.perc.yr = ordered(WEP.EFH.Bio.predict.yr$Bio.EFH.perc.yr, levels=c("95","75","50","25"))
  ...
  save(WEP.EFH.Bio.predict.yr, file = "Analyses/d3WEP_EFH_Bio_contour.rda")
# load("Analyses/d3WEP_EFH_Bio_contour.rda")
...
pa.predictions_all = pa.predictions_all %>%
  rename(pa.fit = fit, pa.se.fit = se.fit)
  save(pa.predictions_all, file = "Analyses/d3WEP_pa_retro.rda") 
# load("Analyses/d3WEP_pa_retro.rda")
...
N.predictions_all = N.predictions_all %>%
  rename(N.fit = fit, N.se.fit = se.fit)
  save(N.predictions_all, file = "Analyses/d3WEP_N_retro.rda") 
# load("Analyses/d3WEP_N_retro.rda")
...
WT.predictions_all = WT.predictions_all %>%
  rename(WT.fit = fit, WT.se.fit = se.fit)
  save(WT.predictions_all, file = "Analyses/d3WEP_WT_retro.rda") 
# load("Analyses/d3WEP_WT_retro.rda")

# all models:
pred.pos_all = N.predictions_all %>% full_join(WT.predictions_all)
  save(pred.pos_all, file = "Analyses/d3WEP_retro_pos.rda") 
# load("Analyses/d3WEP_retro_pos.rda")
